...
export default function AnglophoneSectionPage({
  params,
}: {
  params: Promise<{
    id: string;
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-white">
      ...
      <div className="min-h-screen lg:ml-72">
        ...
        <Navbar
          ...
          subtitle="Anglophone Academic section"
        />
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-4">
                ...
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
              ...
              <p className="mt-4 text-gray-500 dark:text-gray-400">
                Manage classes and subjects for the Anglophone section.
              </p>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              >
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  View and manage all classes in the Anglophone section.
                </p>
              ...
              {/* SUBJECTS */}
              <Link
                href={`/admin/academic-years/${id}/sections/anglophone/subjects`}
              ...
              >
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  View and manage subjects for the Anglophone section.
                </p>
